...
--
-- Host: 127.0.0.1
-- Tempo de geração: 27-Abr-2020 às 04:24
...
(17, NULL, 'pendente', '', 'murraya ', 0, 0, 'aval1', 0, 'avalradicular1', 0, 'a213', 'podaLeve', 'calcada', 'Latitude: 16º 10\' 13\" S Longitude: 42º 17\' 25\" W', 0, 'Não', 0, 'podaLeve1', 'comPavimento', 0, 'monica', 'arvore', 'rutaceae', 0, 'Eucalipto', 'nativa', ''),
...
(2, 25, 2, 'teste de servico', '2020-04-26'),
(3, 24, 2, 'fkaçhfçf', '2020-04-08'),
(4, 25, 2, '54654', '2020-04-08');
...
(24, 'teste', 17, 1, '2020-04-25', 6, 'pendente'),
(25, 'teste', 17, 1, '2020-04-25', 6, 'pendente'),
(26, 'teste', 17, 1, '2020-04-25', 6, 'pendente'),
(27, 'teste', 18, 1, '2020-04-25', 6, 'pendente'),
(28, 'teste 0101', 17, 1, '2020-04-25', 6, 'pendente'),
...
(31, '2432', 17, 1, '2020-04-27', 6, 'pendente'),
(32, '5464', 17, 1, '2020-04-27', 6, 'pendente'),
(34, '42\r\n54', 17, 1, '2020-04-27', 6, 'pendente'),
...
(7, 'colaborador', 'Alfredo Murta sikva', 'alfredo@gamail.com', '12341', '123');
...
--
ALTER TABLE `arvore`
  MODIFY `IdArvore` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `servico`
  MODIFY `codServico` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
