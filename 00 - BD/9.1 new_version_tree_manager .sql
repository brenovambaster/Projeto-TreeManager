...
--
-- Host: 127.0.0.1
-- Tempo de geração: 17-Jun-2020 às 22:21
...
(52, 'tetse', 18, 6, '2020-06-16', 6, 'pendente');
...
(6, 'ativo', 'colaborador', 'Pedrinho ', 'pedrinho@gmail.com', '7987946542', '$5$rounds=9000$gerencia_arvo$aG9BHKnDff2iKmsav93/y2znecxkhRCP921.RdNut68', 'perfil.png'),
(7, 'ativo', 'colaborador', 'Alfredo Murta sikva', 'alfredo@gamail.com', '12341', '123', 'perfil.png'),
(8, 'ativo', 'colaborador', 'teste', 'teste@gmail.com', '123455', '$5$rounds=9000$gerencia_arvo$aG9BHKnDff2iKmsav93/y2znecxkhRCP921.RdNut68', 'perfil.png');
...
--
ALTER TABLE `servico`
  MODIFY `codServico` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
