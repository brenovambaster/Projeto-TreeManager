...
<body>
	...
	<div class="container borda-baixo">
		...
		$retorno = situacaoVizualizar($resultado);
		fecharConexao($con);
		...
		if ($retorno == 1) { ?>
			...
			<div class="box-body">
				...
				<div>
					<h1 class="text-center">Forumuário para vizualização de árvores</h1>
					<hr>
				</div>
				<div class="fundo">
					<div>
				...
				<div class="mt-1">
					<a class="btn btn-outline-info" href="formulario.php?id=<?php echo $id; ?> ">Quero editar os dados</a>
					<a class="btn btn-outline-primary" href="gerenciamento_arvores.php"> Voltar</a>
				</div>
			</div>
...
<?php
function situacaoVizualizar($resultado)
{
